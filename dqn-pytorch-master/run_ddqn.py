...
if __name__ == '__main__':
    ...
    logging.basicConfig(level=logging.INFO,
                        ...
                        datefmt='%m-%d %H:%M',
                        handlers=[logging.FileHandler('ddqn.log'),
                                  logging.StreamHandler()])
    logger = logging.getLogger('ddqn-training')
    ...
    # train model
    train(env, 100000)
    torch.save(policy_net, "double-dqn_pong_model")
    policy_net = torch.load("double-dqn_pong_model")
